...
public class TypeDao {
	...
	public List<Type> queryByMovieId(Integer id) {
		...
		return DbHelp.query(sql, new BeanListHandler<Type>(Type.class, new BasicRowProcessor(new GenerousBeanProcessor())), id);
	}
	...
	public Type queryTypeByTypeId(Integer id) {
		...
		return DbHelp.query(sql, new BeanHandler<Type>(Type.class, new BasicRowProcessor(new GenerousBeanProcessor())), id);
	}
