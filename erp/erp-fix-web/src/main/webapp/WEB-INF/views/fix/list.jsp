                ...
                <div class="box-body">
                    ...
                    <c:forEach items="${fixOrderList}" var="fixOrder">
                        <div class="panel panel-info">
                            <div class="panel-heading"><a href="/fix/detail/${fixOrder.orderId}">订单号：${fixOrder.orderId}</a> - ${fixOrder.carType} - ${fixOrder.orderType}
                                <c:if test="${fixOrder.orderState == '2'}">
    ...
    $(function(){
        ...
        $(".getBtn").click(function(){
            ...
            layer.confirm("确定要接单吗?",function (index) {
                ...
                $.get("/fix/trans/" + orderId).done(function (res) {
                    if(res.state == "success") {
                        window.location.href = "/fix/detail/" + orderId;
                    } else {
                        layer.msg(e.message);
                    }
                }).error(function () {
