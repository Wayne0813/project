            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                    ...
                    <c:if test="${order.state == '1'}">
                        <a href="/order/edit/${order.id}" class="btn bg-purple btn-sm"><i class="fa fa-pencil"></i> 修改订单</a>
    ...
    $(function() {
        ...
        $("#delBtn").click(function(){
            layer.confirm("确定要删除吗?",function (index) {
                layer.close(index);
                window.location.href = "/order/del/" + orderId;
            });
        });
        ...
        $("#transBtn").click(function(){
            layer.confirm("确定要下发订单么？如此将不能修改和删除订单！",function (index) {
                layer.close(index);
                $.get("/order/trans/" + orderId).done(function(res){
