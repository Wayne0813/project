            ...
            <div class="box no-border">
                <div class="box-body">
                    <form class="form-inline pull-left">
                        <input type="text" value="${param.partsName}" name="partsName" placeholder="配件名称" class="form-control">
                        <input type="text" value="${param.partsInventory}" name="partsInventory" placeholder="配件库存" class="form-control">
                        <select class="form-control" name="partsType" id="partsType">
                            <option value="">请选择配件类型</option>
                            <c:forEach items="${typeList}" var="type">
                                <option ${param.partsType == type.id ? 'selected' : ''} value="${type.id}">${type.typeName}</option>
                            </c:forEach>
                        </select>
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${page.list}" var="parts">
                            <tr>
                                ...
                                <td>${parts.address}</td>
                                <td><a href="/parts/edit/${parts.id}">更新</a> / <a class="deleteBtn" partsNo="${parts.partsNo}" rel="${parts.id}" href="javascript:;">删除</a> </td>
                            </tr>
                        </c:forEach>
